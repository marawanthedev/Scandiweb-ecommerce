            ...
            < div className="category-item" >
                {
                    inStock === false ?
                        <div className="category-item__out-of-stock-overlay">
                            <span className="category-item__out-of-stock-overlay__text">Out of stock
                            </span>
                        </div>
                        : null
                }

                <Link ref={link => this.redirectLink = link} className="category-item__link" to={redirectionInfo}>
                ...
                {
                    inStock ?
                        <div className="category-item__add-to-cart-btn" onClick={() => this.handleCartAddition(item)}>
