...
class CartPageItemGallery extends React.PureComponent {
    ...
    render() {
        ...
        return (
            <div className="cart__item__gallery" style={{ backgroundImage: `url(${gallery[imageSelectionIndex]})` }}>

                {
                    gallery.length > 1 ?
                        <div>
                            <div className="cart__item__gallery__prev" onClick={() => this.prevImage(gallery, imageSelectionIndex)}>
